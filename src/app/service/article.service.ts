...
export class ArticleService {
  ...
  // getFullTextByID(articleID: string): Observable<any> {
  //   return this.httpClient.post<any>(`${this.apiUrl}/getFullTextByIdMongo`, {
  //     articleID,
  //   });
  // }
  ...
  //   journalists: string[]
  // ) {
  //   return this.httpClient.post<any>(`${this.apiUrl}/updateArticleMongo`, {
  //     id,
  //     title,
  //     sub_title,
  //     isPremium,
  ...
  addToClient(body: {
      ...
      return this.httpClient.post<any>(`${this.apiUrl}/addToClient`, body);
    }
}
